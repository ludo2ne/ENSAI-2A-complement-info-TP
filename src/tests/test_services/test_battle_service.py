...
class TestBattleService(TestCase):
    def test_resolve_battle(self):
        ...
        combat = battle_service.resolve_battle(
            monstie_1=pikachu,
            monstie_2=snorlax
        )
    ...
    def test_get_order_no_draw(self):
        ...
        speed_pikachu = 50
        speed_charizard = 40
        pikachu = AbstractPokemon(
            stat_current=Statistic(speed=speed_pikachu))
        charizard = AbstractPokemon(
            stat_current=Statistic(speed=speed_charizard))
    ...
    def test_choose_attack_1(self):
        ...
        pikachu = AttackerPokemon(
            name="pikachu",
            common_attacks=[tonnerre, vive_attaque]
        )
        battle_service = BattleService()
